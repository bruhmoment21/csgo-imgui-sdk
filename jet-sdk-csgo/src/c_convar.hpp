...
public:
	float get_float()
	{
		return utilities::call_virtual< float, 12 >(this);
	}

	int get_int()
	{
		return utilities::call_virtual< int, 13 >(this);
	}

	void set_value(const char* value)
	{
		return utilities::call_virtual< void, 14, const char* >(this, value);
	}

	void set_value(const float value)
	{
		return utilities::call_virtual< void, 15, float >(this, value);
	}

	void set_value(const int value)
	{
		return utilities::call_virtual< void, 16, int >(this, value);
	}
