...
namespace signatures
{
	void initialize()
	{
		...
		update_inventory_address = reinterpret_cast<decltype(update_inventory_address)>(pattern_scan<17>("client.dll",
			{0xE8, -1, -1, -1, -1, 0x83, 0xC4, 0x04, 0x80, 0xBF, -1, -1, -1, -1, -1, 0x74, 0x0C}));
