...
enum material_var_flags_t
{
	...
	material_var_unused_2 = (1 << 18), // unused
...
public:
	...
	virtual preview_image_retval_t get_preview_image_properties(int* width, int* height, image_format_t* image_format, bool* is_translucent) const = 0;
